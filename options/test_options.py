...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--original_domain', type=str, default='A', help='original domain (can be either A or B)')

        # Add YeaZ options
        parser.add_argument('--path_to_yeaz_weights', default=None, type=str, help="Specify YeaZ weights path.")
        ...
        # Add general options
        parser.add_argument('--skip_style_transfer', action='store_true', help='Skip style transfer.')
        parser.add_argument('--skip_segmentation', action='store_true', help='Skip segmentation.')
        parser.add_argument('--skip_metrics', action='store_true', help='Skip metrics.')
